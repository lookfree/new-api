...
type Model struct {
	...
	// ContextLength is the context window in tokens, shown on the model
	// marketplace card. Zero means unknown and the card omits it.
...
func (mi *Model) Update() error {
	...
	return DB.Model(&Model{}).Where("id = ?", mi.Id).
		Select("model_name", "description", "icon", "tags", "context_length", "vendor_id", "endpoints", "status", "sync_official", "name_rule", "updated_time").
		Updates(mi).Error
}
