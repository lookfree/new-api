    ...
    <section className='relative z-10 overflow-hidden px-6 pt-24 pb-16 md:pt-32 md:pb-24 lg:pt-36 lg:pb-28'>
      ...
      <div
        ...
        style={{
          background: [
            ...
            'radial-gradient(ellipse 40% 35% at 40% 80%, color-mix(in oklch, var(--primary) 35%, transparent) 0%, transparent 70%)',
          ].join(', '),
        }}
      />
      {/* Grid pattern */}
      ...
      <div className='mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8'>
        ...
        <div className='flex flex-col items-start text-left lg:col-span-6'>
          {/* Top Pill Badge */}
          <div
            className='landing-animate-fade-up text-primary bg-primary/10 mb-5 inline-flex items-center gap-1.5 rounded-full border border-transparent px-3 py-1.5 text-[11px] font-medium opacity-0 shadow-xs'
